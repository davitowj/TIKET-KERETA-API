    ...
    return (
        <div className="w-full flex  flex-wrap my-2 border rounded-md">
            <div className="w-full p-2 md:w-4/12 flex flex-col">
                <small className="text-sm font-medium">Nama Kereta</small>
                <span>
            ...
            <div className="w-full p-2 md:w-4/12 flex flex-col">
                <small className="text-sm font-medium">Deskripsi Kereta</small>
                <span>
            ...
            <div className="w-full p-2 md:w-2/12 flex flex-col">
                <small className="text-sm font-medium">Tipe Kereta</small>
                <span>
                    {myProp.item.type}
                </span>
            </div>
