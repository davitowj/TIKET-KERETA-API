...
const DropPelanggan = (myProps: props) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        try {
            ...
            const url = `/customer/${myProps.pelanggan.id}`
            ...
            if (response.data.success == true) {
                toast(message, {
                    containerId: `toastDrop-${myProps.pelanggan.id}`,
                    type: "success"
                })
    ...
    return (
        <div>
            <ToastContainer containerId={`toastDrop-${myProps.pelanggan.id}`} />
            <button type="button"
                onClick={() => openModal()}
